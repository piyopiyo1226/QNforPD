...
namespace arcsim {
	...
	//Vec3 ReferenceSphere::closest_point(const Vec3 &p) { return center + radius * normalize(p - center); }
	...
	//Vec3 ReferenceLinear::closest_point(const Vec3 &p) { return p; }
	...
	//Vec3 ReferenceMesh::closest_point(const Vec3 &p) { return p; }

	//bool ReferenceMesh::raycast(Vec3 &p, const Vec3 &dir) { return false; }
